...
public class RemoveAdsOfferView : BaseUIViewController<RemoveAdsOfferViewRefs>
{
	[CompilerGenerated]
	private sealed class _003CHandleTimeCounter_003Ed__18 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		public RemoveAdsOfferView _003C_003E4__this;
	...
	private void SetDataWithOffer(ISpecialOffer iSpecialOffer)
	{
	}

	private void SetOfferBGState(bool inGameOffer)
	{
	}
