...
public class ColumnSortOnGrid : BaseGridBooster
{
	[CompilerGenerated]
	private sealed class _003CMovementAnimationCR_003Ed__4 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		public ColumnSortOnGrid _003C_003E4__this;
	...
	public ColumnSortOnGrid(MonoBehaviour mono, IGridBooster gridBooster)
		: base(null)
	{
	}

	public void ApplyBooster(Slot slot, List<Slot> slots, int columns, int rows, ArrayArrayInt slotsCurrentState)
	{
	}
